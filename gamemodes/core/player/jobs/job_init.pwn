...
stock Account_GetJob(const playerid) return PlayerData[playerid][pJob];
stock Account_SetJob(const playerid, const jobid) return PlayerData[playerid][pJob] = jobid;
