...
stock WeedGrower_GetPlayerMarijuana(const playerid) return PlayerData[playerid][pWeed];
stock WeedGrower_SetPlayerMarijuana(const playerid, const value) return PlayerData[playerid][pWeed] = value;
...
stock WeedGrower_SetCheckpoint(const playerid, const checkpoint)
{
    ...
    switch (checkpoint)
    {
        ...
        case 14:
        {
            ...
            weedGrowerZCoordinate[playerid] = 0.00;
        }
        ...
        case 15:
        {
            ...
            WeedGrower_SetPlayerMarijuana(playerid, (WeedGrower_GetPlayerMarijuana(playerid) + marijuana));
